...
class _NowPlayingWidgetState extends State<NowPlayingWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NowPlayingCubit, NowPlayingCubitState>(
                ...
                children: [
                  Expanded(
                    child: ListView.separated(
                      controller:
                          context.read<NowPlayingCubit>().scrollController,
